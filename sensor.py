...
class MoistureSensorConfig(object):
...
class MoistureSensor(object):
    def __init__(self):
        ...
        self.broker_address = ''
        self.port = 1883
        self.conf = MoistureSensorConfig("sensor_conf.json")
    ...
    def start(self):
        print('Connecting to Broker and starting transition')
    ...
    def publish_sensor_reading(self):
        print("Reading moisture sensor values...")
        time.sleep(1)
        #TODO: in meghdar, rasspbery bayad az sensor bekhoneh
        msg = snmsg()
        msg.setValues(moisture=randrange(50),
                      bn=self.device_id,
                      bt=int(time.time()))
